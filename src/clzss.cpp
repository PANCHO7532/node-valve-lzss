...
void CLZSS::BuildHash( unsigned char *pData )
{
	...
	// P7: I'm really *not sure* how this would affect the entire thing
	// But it refuses to compile on 64 bit platforms for this reason.
	// Hopefully by doing this it should cast without any problems... probably.
